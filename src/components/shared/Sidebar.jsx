...
const Sidebar = () => {
    ...
    return (
        <header>
            <nav>
                <div className={"absolute bg-primary-light w-100p h-screen rounded-r-3xl flex flex-col justify-between"}>
                    <div className={"bg-secondary-dark w-full h-100p rounded-r-3xl cursor-pointer"}>
                        <img className={"relative top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-fit z-20"} src={logo} alt=""/>
                        <div className={"bg-secondary-light w-full h-1/2 rounded-tl-3xl rounded-br-3xl transform translate-y-1/2 hover:h-2/3 hover:translate-y-0 transition-all duration-300"}></div>
                    </div>
                ...
                <div className={`absolute left-32 bottom-4 flex flex-col justify-center items-center bg-primary-light rounded-2xl p-4 text-white font-primary w-180p ${!profileClicked ? "hidden" : ""}`}>
                    <ul>
